...
public interface MessageDAO {
    ...
    @Insert({"insert into ", TABLE_NAME, "(", INSERT_FIELDS ,") values(#{fromId}, #{toId}, #{content}, #{has_read}, #{conversationId}, #{createdDate})"})
    ...
    int updateHasRead(@Param("hasRead") int hasRead,@Param("id") int id);
}
